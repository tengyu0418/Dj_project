...
class Chapter3ProjectStructureTests(TestCase):
    ...
    def test_project_created(self):
        ...
        """
        directory_exists = os.path.isdir(os.path.join(self.project_base_dir, 'Dj_project'))
        urls_module_exists = os.path.isfile(os.path.join(self.project_base_dir, 'Dj_project', 'urls.py'))
